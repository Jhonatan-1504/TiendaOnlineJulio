                        ...
                        <div class="card-body p-5 text-center">
                            <form id="formRegister">
                                <div class="mb-md-1 mt-md-1 ">
                                    ...
                                    <h2 class="fw-bold mb-2 text-uppercase">Modificar Contraseña ADM</h2>
                                    ...
                                    <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="../LoginAdmin/RegisterAdm.php">Registrate !!</a>
                                    </p>
                                ...
                                <div>
                                    <p class="mb-0">Ya tienes una cuenta? <a href="../LoginAdmin/LoginAdm.php"
