...
<body>
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          ...
          <form id="formRegister">
            <div class="mb-md-1 mt-md-1 ">
              ...
              <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="#!">Registrate !!</a></p>
  ...
  async function HandleSubmit(event){
    event.preventDefault();
       ...
       let dato =  await fetch('http://localhost/TiendaOnlineJulio/api/controllers/UsuarioController.php?option=updatePassword',{method:"POST",body:MisDatos});
       console.log(dato);
